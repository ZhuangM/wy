...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td width="20%" height="60"><h1>生产设备管理平台</h1></td>
			<td width="80%" align="right" valign="bottom">
				<table width="750" border="0" cellpadding="0">
					<tr>
						<td align="right" height="26"
							style="padding-right: 10px; line-height: 26px;">您好：<span
							class="username"><s:property value="#session.name" /></span>，欢迎登录生产设备管理平台！
							...
							<dl id="tpa">
								<dd>
									<div class="itemsel" id="iteml"
										...
										<a href="ow/menu.jsp" target="menu" onclick="changeSel(1)">主菜单</a>
									</div>
								</dd>
							</dl>
						</td>
